...
!
      ...
      real(r8) :: tl_g_max   = 0.0_r8
      real(r8) :: tl_t_opt   = 0.0_r8
      real(r8) :: tl_I_opt   = 0.0_r8
      ...
      real(r8) :: tl_Chl2C_m = 0.0_r8   ! mg_Chl/mg_C
      real(r8) :: tl_ChlMin  = 0.0_r8   ! mg_Chl/m3
      real(r8) :: tl_CoagR   = 0.0_r8   ! 1/day
      real(r8) :: tl_D_p5NH4 = 0.0_r8   ! Watts/m2
      real(r8) :: tl_I_thNH4 = 0.0_r8   ! Watts/m2
      real(r8) :: tl_K_NH4   = 0.0_r8   ! m3/mmol_N
      real(r8) :: tl_K_NO3   = 0.0_r8   ! m3/mmol_N
      real(r8) :: tl_K_Phy   = 0.0_r8   ! (mmol_N/m3)^2
      ...
      real(r8) :: tl_PhyIS   = 0.0_r8   ! 1/(Watts m-2 day)
      real(r8) :: tl_PhyMin  = 0.0_r8   ! mmol_N/m3
...
# endif
      ...
      real(r8) :: ad_g_max   = 0.0_r8
      real(r8) :: ad_t_opt   = 0.0_r8
      real(r8) :: ad_I_opt   = 0.0_r8
      ...
      real(r8) :: ad_Chl2C_m = 0.0_r8   ! mg_Chl/mg_C
      real(r8) :: ad_ChlMin  = 0.0_r8   ! mg_Chl/m3
      real(r8) :: ad_CoagR   = 0.0_r8   ! 1/day
      real(r8) :: ad_D_p5NH4 = 0.0_r8   ! Watts/m2
      real(r8) :: ad_I_thNH4 = 0.0_r8   ! Watts/m2
      real(r8) :: ad_K_NH4   = 0.0_r8   ! m3/mmol_N
      real(r8) :: ad_K_NO3   = 0.0_r8   ! m3/mmol_N
      real(r8) :: ad_K_Phy   = 0.0_r8   ! (mmol_N/m3)^2
      real(r8) :: ad_LDeRRN  = 0.0_r8   ! 1/day
      real(r8) :: ad_LDeRRC  = 0.0_r8   ! 1/day
      ...
      real(r8) :: ad_PhyIS   = 0.0_r8   ! 1/(Watts m-2 day)
      real(r8) :: ad_PhyMin  = 0.0_r8   ! mmol_N/m3
      ...
      real(r8) :: ad_Vp0     = 0.0_r8   ! nondimensional
      real(r8) :: ad_wLDet   = 0.0_r8   ! m/day
      real(r8) :: ad_wPhy    = 0.0_r8   ! m/day
